...
import com.mentalhealthforum.mentalhealthforum_backend.service.OnboardingService;
        ...
        return adminInvitationRepository.findByKeycloakId(userId)
                ...
                .switchIfEmpty(Mono.defer(()-> appUserRepository.findAppUserByKeycloakId(String.valueOf(userId))
                        .map(appUser->{
                            ...
                            OnboardingStage onboardingStage = result.isSatisfied()? null: OnboardingStage.AWAITING_PROFILE_COMPLETION;
