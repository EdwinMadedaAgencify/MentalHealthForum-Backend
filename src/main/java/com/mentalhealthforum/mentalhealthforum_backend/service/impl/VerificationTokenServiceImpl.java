...
public class VerificationTokenServiceImpl implements VerificationTokenService {
     ...
     */
    @Override
    public Mono<VerificationTokenEntity> generateToken(String email, VerificationType type, String groupPath, String newValue) {
    ...
    @Override
    public Mono<VerificationTokenEntity> findByEmail(String email){
        String normalizedEmail = email.trim().toLowerCase();
    ...
    @Override
    public Mono<VerificationTokenEntity> findTokenByEmailAndType(String email, VerificationType type){
        String normalizedEmail = email.trim().toLowerCase();
     ...
     */
    @Override
    public Mono<VerificationTokenEntity> findAndValidateToken(String token, String email) {
